...
class Tetris:
    ...
    def __init__(self,screen):
        ...
        pygame.display.set_caption('Tetris Cheater Training')
    ...
    def step(self, action=[0, -1], end=False):
        ...
        self.draw_stats()
        #area = pygame.Rect(self.top_left_x + 400, self.top_left_y - 50, 200, 300)
        pygame.display.update()
        return score, self.run
